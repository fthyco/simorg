        ...
        <div className="app-layout" style={{ background: "#ffffff", overflowY: "auto" }}>
            <header className="app-header">
                <Link href="/" style={{ textDecoration: "none" }}>
                    <div className="header-brand" style={{ cursor: "pointer" }}>SimOrg <span style={{ color: "var(--text-muted)", marginLeft: "8px", fontSize: "11px", fontWeight: "normal" }}>Control Center</span></div>
                </Link>
                <div className="header-meta">
                    <Link href="/" className="btn btn-secondary btn-sm" style={{ textDecoration: "none" }}>About</Link>
